...
cd ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_sd2d.tst.d || echo "cd ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_sd2d.tst.d EXEC_FALI" >&2
...
#     echo "in fs= file://${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_sd2d.tst.d/_sd2d.tst.sh , line=${LINENO} : EXEC_FAIL : '_sd2d _XXX _RES tst.d/init_XXX.d' : ${hint} : return 1"
#     # return 1
# fi
...
# _sd2d >/dev/null
# . '/home/st/.d/.rc.d/.st.rc.d/.st.tst.d/_sd2d.tst.d/_sd2d.tst.sh'
...
if [ 0 -eq "$flag" ]; then
    echo "in file://${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_sd2d.tst.d/_sd2d.tst.sh fail" >&2
    diff res pre >&2
    return 1
else
    echo "in file://${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_sd2d.tst.d/_sd2d.tst.sh true"
    return 0
fi
