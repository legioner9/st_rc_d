...
___drNTf_TST_SH() {
    ...
    touch that.file
    touch d1/d2/newer.file
    echo -e "${HLIGHT}--- _drNTf d1 that.file ---${NORMAL}" >>${tst_dir}/res
    _drNTf "d1" that.file >>${tst_dir}/res

    touch d1/d2/newer.file
    touch that.file
    echo -e "${HLIGHT}--- _drNTf 1 that.file ---${NORMAL}" >>${tst_dir}/res
    _drNTf "d1" that.file >>${tst_dir}/res
