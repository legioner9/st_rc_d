...
___d2f_marg_TST() {
    ...
    if ! command -v _d2f_marg; then
        echo "TYPE_ERROR : _d2f_marg" >&2
        return 1
    fi
    ...
    # if ! [[ $(. ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_d2f_marg.tst.d/_d2f_marg.tst.sh) == "_d2f_marg" ]]; then
    #     echo "in fs=file://${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_d2f_marg.tst , line=${LINENO}, pwd=${PWD}" >&2
    #     echo "EXEC_FAIL : '\$(. ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_d2f_marg.tst.d/_d2f_marg.tst.sh) == _d2f_marg' : return 1" >&2
    #     return 1
    # fi
