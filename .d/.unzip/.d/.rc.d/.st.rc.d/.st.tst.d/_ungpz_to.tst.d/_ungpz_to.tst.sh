...
___ungpz_to_TST_SH() {
    ...
    local tst_dir_file=${tst_dir}/_ungpz_to.tst.sh.deb1
    local tst_lst_env=${tst_dir}/.lst/tst_env.lst

    local data_dir=${HOME}/.d/.rc.d/.st.rc.d/.st.sh.data.d/_ungpz_to.d
    local data_dir_lst=${HOME}/.d/.rc.d/.st.rc.d/.st.sh.data.d/_ungpz_to.d/.lst
