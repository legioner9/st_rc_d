...
_bcp_strc() {
    ...
    if [[ "-h" == "$1" ]]; then
        echo -e "
MAIN: ${FNN} :: bcp mirror ~/.d/.rc.d/.st.rc.d to ${ST_SH_D_PATH}/st_rc_d/.d/.d/.rc.d/.st.rc.d
TAGS:
\$1 
[, \$2]
CNTL: 
...
"
    ...
    echo -e "${RED}--------------------- _is_dDIFz ${HOME}/.d/.rc.d/.st.rc.d ${ST_RC_D_PATH}/.d/.zip/.st.rc.d.zip: --------------------${NORMAL}"
    if _is_dDIFz ${HOME}/.d/.rc.d/.st.rc.d ${ST_RC_D_PATH}/.d/.zip/.st.rc.d.zip; then
        echo "in fs= file://${HOME}.st.rc.d/.st.sh.d/_bcp_strc.sh , line=${LINENO}, ${FNN}() : in file://${HOME}/.d/.rc.d/.st.rc.d NOT _is_dDIFz file://${ST_RC_D_PATH}/.d/.zip/.st.rc.d.zip :: return 0"

        cd $PPWD
        return 0
    fi

    if _is_yes "DO? ZIP file://${HOME}/.d/.rc.d/.st.rc.d TO file://${ST_RC_D_PATH}/.d/.zip/.st.rc.d.zip"; then
        echo -e "${HLIGHT}--- exec: _zip_to file://${ST_RC_D_PATH}/.d/.zip/.st.rc.d.zip file://${HOME}/.d/.rc.d/.st.rc.d \
---${NORMAL}" #start files
        if ! _zip_to ${ST_RC_D_PATH}/.d/.zip/.st.rc.d.zip ${HOME}/.d/.rc.d/.st.rc.d >/dev/null; then
            echo "in fs= file://${HOME}.st.rc.d/.st.sh.d/_bcp_strc.sh , line=${LINENO}, ${FNN}() : : EXEC_FAIL :\
 '_zip_to file://${ST_RC_D_PATH}/.d/.zip/.st.rc.d.zip file://${HOME}/.d/.rc.d/.st.rc.d' : ${hint} : return 1" >&2
    ...
    echo -e "${HLIGHT}--- exec: diff -rq ${ST_RC_D_PATH}/.d/.zip/tmp/.d/.rc.d/.st.rc.d ${HOME}/.d/.rc.d/.st.rc.d\
 ---${NORMAL}" #start files
    if ! diff -rq ${ST_RC_D_PATH}/.d/.zip/tmp/.d/.rc.d/.st.rc.d ${HOME}/.d/.rc.d/.st.rc.d >/dev/null; then
        echo "in fs= file://${HOME}.st.rc.d/.st.sh.d/_bcp_strc.sh , line=${LINENO} : : EXEC_FAIL :\
 'diff ${ST_RC_D_PATH}/.d/.zip/tmp/.d/.rc.d/.st.rc.d ${HOME}/.d/.rc.d/.st.rc.d' : ${hint} : return 1" >&2
        diff -r ${ST_RC_D_PATH}/.d/.zip/tmp/.d/.rc.d/.st.rc.d ${HOME}/.d/.rc.d/.st.rc.d
