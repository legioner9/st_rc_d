...
___lcu_opus_TST_SH() {
    ...
    local tst_dir_file=${tst_dir}/_lcu_opus.tst.sh.deb1
    local tst_lst_env=${tst_dir}/.lst/tst_env.lst
    
    local data_dir=${HOME}/.d/.rc.d/.st.rc.d/.st.sh.data.d/_lcu_opus.d
    local data_dir_lst=${HOME}/.d/.rc.d/.st.rc.d/.st.sh.data.d/_lcu_opus.d/.lst
