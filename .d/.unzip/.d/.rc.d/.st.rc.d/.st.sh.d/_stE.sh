...
_stE() {
    ...
    if [[ "-h" == "$1" ]]; then
        echo -e "
MAIN: ${FUNCNAME} :: catalog strc_fn form ${HOME}/.d/.rc.d/.st.rc.d/st.sh.d
TAGS:
\$1 
[, \$2]
CNTL: 
    _e : body    : _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_stE.sh
    _t : tst_dir : _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_stE.tst.d
EXAM: 
    ${FUNCNAME}
"
        return 0
    ...
    if [[ "_e" == "$1" ]]; then
        _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_stE.sh
        return 0
    fi

    if [[ "_t" == "$1" ]]; then
        _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_stE.tst.d
        return 0
    fi
