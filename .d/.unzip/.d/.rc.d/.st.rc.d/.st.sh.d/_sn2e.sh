...
_sn2e() {
    ...
    #? ----- START _sn2e body_prepeare -----

    local hint="hint->"
    if [[ "-h" == "$1" ]]; then
        echo -e "
MAIN: ${FNN} :: stdout 'str' \$1 multyplay 'str''str'...'str' \$2 (num) times
TAGS: 
\$1 
[, \$2]
...
"
    ...
    #* check _isn_from
    hint="stdout 'str' \$1 multyplay 'str''str'...'str' \$2 (num) times"
