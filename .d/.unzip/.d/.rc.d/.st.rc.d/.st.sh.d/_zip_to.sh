...
_zip_to() {
    ...
    if ! [[ -d ${PPWD} ]]; then
        echo "in fs= file://${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_bcp_strc.sh , line=${LINENO}, ${FNN}() : \${PPWD} NOT_DIR : 'file://${PPWD}' : ${hint} : return 1"
        return 1
    fi
...
TAGS: @zip
    ...
    \$2 src node
CNTL: 
    _e : body            : _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_zip_to.sh
    _t : tst_dir         : _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_zip_to.tst.d
    _d : exec tst_dir_fn : . ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_zip_to.tst.d/_zip_to.tst.sh
EXAM: 
    ${FUNCNAME}
"
        return 0
    ...
    if [[ "_e" == "$1" ]]; then
        _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_zip_to.sh
        return 0
    fi

    if [[ "_t" == "$1" ]]; then
        _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_zip_to.tst.d
        return 0
    fi

    if [[ "_d" == "$1" ]]; then
        . ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_zip_to.tst.d/_zip_to.tst.sh
        return 0
    fi
