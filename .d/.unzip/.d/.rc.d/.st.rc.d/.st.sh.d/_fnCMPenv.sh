...
_fnCMPenv() {
    ...
    if [[ "-h" == "$1" ]]; then
        echo -e "
MAIN: ${FNN} :: compare env ${HOME}/.d/.rc.d/.st.rc.d/.st.config.d/fn_name.sh with real ${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d
TAGS: @cmp @env 
\$1 
[, \$2]
CNTL: 
...
"
    ...
    local name_env=${HOME}/.d/.rc.d/.st.rc.d/.st.config.d/fn_name.sh
    local dir_data=${STRC_DATA_PATH}/.d/.st.rc.data.d/_fnCMPenv
    local dir_sh=${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d

    #* ${STRC_DATA_PATH}/.d/.st.rc.data.d

    sort ${HOME}/.d/.rc.d/.st.rc.d/.st.config.d/fn_name.sh -o ${HOME}/.d/.rc.d/.st.rc.d/.st.config.d/fn_name.sh
