...
[, \$2]
CNTL: 
    _e : _edit body      : _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_unzip_to.sh
    _t : _edit tst_dir   : _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_unzip_to.tst.d
    _d : exec tst_dir_fn : . ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_unzip_to.tst.d/_unzip_to.tst.sh
EXAM: 
    ${FUNCNAME}
"
        return 0
    ...
    if [[ "_e" == "$1" ]]; then
        _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_unzip_to.sh
        return 0
    fi

    if [[ "_t" == "$1" ]]; then
        _edit ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_unzip_to.tst.d
        return 0
    fi

    if [[ "_d" == "$1" ]]; then
        . ${HOME}/.d/.rc.d/.st.rc.d/.st.tst.d/_unzip_to.tst.d/_unzip_to.tst.sh
        return 0
    fi
    ...
    if ! [[ -f $2 ]]; then
        hint="\$2: zip file"
        echo "in fs= file://${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_zip_to.sh , line=${LINENO}, ${FNN}() : NOT_FILE : 'file://$2' : ${hint} : return 1" >&2
        return 1
    fi

    if ! [[ -d $1 ]]; then
        hint="\$1: dir dist"
        echo "in fs= file://${HOME}/.d/.rc.d/.st.rc.d/.st.sh.d/_zip_to.sh , line=${LINENO}, ${FNN}() : NOT_DIR : 'file://$1' : ${hint} : return 1" >&2
        return 1
    fi
