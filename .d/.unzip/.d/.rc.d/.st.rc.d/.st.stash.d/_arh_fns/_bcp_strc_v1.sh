...
---${NORMAL}" #start files
 ...
 '_zip_to file://${ST_RC_D_PATH}/.d/.zip/.st.rc.d.zip file://${HOME}/.d/.rc.d/.st.rc.d' : ${hint} : return 1" >&2
    ...
    echo -e "${HLIGHT}--- exec: diff -rq ${ST_RC_D_PATH}/.d/.zip/tmp/.st.rc.d ${HOME}/.d/.rc.d/.st.rc.d\
 ---${NORMAL}" #start files
    if ! diff -rq ${ST_RC_D_PATH}/.d/.zip/tmp/.st.rc.d ${HOME}/.d/.rc.d/.st.rc.d >/dev/null; then
