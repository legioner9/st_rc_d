...
filename="${ST_RC_D_PATH}/.d/.arb/stl0.arb/doxy_stl0_stl0.ram/.grot/doxy_stl0.sh"
...
doxy_stl0_stl0() {
    ...
    local fn_sh_file=${ST_RC_D_PATH}/.d/.arb/stl0.arb/doxy_stl0_stl0.ram/.grot/doxy_stl0.sh
    local d_name=$(dirname ${ST_RC_D_PATH}/.d/.arb/stl0.arb/doxy_stl0_stl0.ram/.grot/doxy_stl0.sh)
