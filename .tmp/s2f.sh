...
dqwedvgf_2134() {
    ...
    echo -e "${GREEN}\$1 = '$0'${NORMAL}" #print variable
    echo -e "${GREEN}\$2 = '$1'${NORMAL}" #print variable
    echo -e "${GREEN}\$3 = '$2'${NORMAL}" #print variable
    echo -e "${GREEN}\$4 = '$3'${NORMAL}" #print variable
